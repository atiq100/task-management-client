...
const AddTask = () => {
    ...
    <form onSubmit={handleSubmit(handleAddTask)}>
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
                <label className="text-gray-700 dark:text-gray-200" htmlFor="taskname">Task name</label>
            ...
            <div>
                <label className="text-gray-700 dark:text-gray-200" htmlFor="taskimage">Task image</label>
